...
class MoviesTvShowsRepository private constructor(
    ...
    private val appExecutors: AppExecutors) : MoviesTvShowsDataSource {

    companion object {
        @Volatile
        private var instance: MoviesTvShowsRepository? = null
        fun getInstance(remoteData: RemoteDataSource, localData: LocalDataSource, appExecutors: AppExecutors): MoviesTvShowsRepository =
            instance ?: synchronized(this) {
                instance ?: MoviesTvShowsRepository(remoteData, localData, appExecutors).apply { instance = this }
            }
    }
